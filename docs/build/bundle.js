    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(td3, "class", "center-txt svelte-130wkro");
    			add_location(td3, file$5, 54, 10, 1521);
    			attr_dev(td4, "class", "center-txt svelte-130wkro");
    			add_location(td4, file$5, 55, 10, 1562);
    			attr_dev(td5, "class", "center-txt svelte-130wkro");
    			toggle_class(td5, "circle", /*numbers*/ ctx[5][0] === "1");
    			add_location(td5, file$5, 56, 10, 1603);
    			attr_dev(td6, "class", "center-txt svelte-130wkro");
    			toggle_class(td6, "circle", /*numbers*/ ctx[5][0] === "2");
    			add_location(td6, file$5, 57, 10, 1680);
    			attr_dev(td7, "class", "center-txt svelte-130wkro");
    			toggle_class(td7, "circle", /*numbers*/ ctx[5][0] === "3");
    			add_location(td7, file$5, 58, 10, 1757);
    			attr_dev(td8, "class", "center-txt svelte-130wkro");
    			toggle_class(td8, "circle", /*numbers*/ ctx[5][0] === "4");
    			add_location(td8, file$5, 59, 10, 1834);
    			attr_dev(tr0, "class", "svelte-130wkro");
    			add_location(tr0, file$5, 53, 8, 1505);
    			attr_dev(td9, "class", "center-txt svelte-130wkro");
    			attr_dev(td9, "colspan", "2");
    			toggle_class(td9, "circle", !/*twister*/ ctx[4] && /*numbers*/ ctx[5][2] === "1" || /*numbers*/ ctx[5][1] === "1");
    			add_location(td9, file$5, 62, 10, 1940);
    			attr_dev(td10, "class", "center-txt answer svelte-130wkro");
    			attr_dev(td10, "colspan", "2");
    			add_location(td10, file$5, 68, 10, 2132);
    			attr_dev(td11, "class", "center-txt answer svelte-130wkro");
    			attr_dev(td11, "colspan", "2");
    			add_location(td11, file$5, 81, 10, 2642);
    			attr_dev(tr1, "class", "svelte-130wkro");
    			add_location(tr1, file$5, 61, 8, 1924);
    			attr_dev(td12, "class", "col20 center-txt svelte-130wkro");
    			attr_dev(td12, "colspan", "2");
    			add_location(td12, file$5, 93, 10, 3043);
    			attr_dev(td13, "class", "col20 center-txt svelte-130wkro");
    			toggle_class(td13, "circle", /*pos*/ ctx[3] === "C");
    			add_location(td13, file$5, 94, 10, 3104);
    			attr_dev(td14, "class", "col20 center-txt svelte-130wkro");
    			toggle_class(td14, "circle", /*pos*/ ctx[3] === "B");
    			add_location(td14, file$5, 95, 10, 3180);
    			attr_dev(td15, "class", "col20 center-txt svelte-130wkro");
    			toggle_class(td15, "circle", /*pos*/ ctx[3] === "A");
    			add_location(td15, file$5, 96, 10, 3257);
    			attr_dev(td16, "class", "col20 center-txt svelte-130wkro");
    			toggle_class(td16, "circle", /*pos*/ ctx[3] === "D");
    			add_location(td16, file$5, 97, 10, 3333);
    			attr_dev(tr2, "class", "svelte-130wkro");
    			add_location(tr2, file$5, 92, 8, 3027);
