...
var app = (function () {
    ...
    function create_else_block_1(ctx) {
    	let t_value = (/*numbers*/ ctx[8][2] >= 2
    	? `${Math.floor(parseInt(/*numbers*/ ctx[8][2]) / 2)} 
                ${parseInt(/*numbers*/ ctx[8][2]) % 2 === 1 ? "1/2" : ""} S.S.`
    	: "") + "";
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*numbers*/ 256 && t_value !== (t_value = (/*numbers*/ ctx[8][2] >= 2
    			? `${Math.floor(parseInt(/*numbers*/ ctx[8][2]) / 2)} 
                ${parseInt(/*numbers*/ ctx[8][2]) % 2 === 1 ? "1/2" : ""} S.S.`
    ...
    function create_if_block_1$1(ctx) {
    	let t_value = (/*numbers*/ ctx[8][1] >= 2
    	? `${Math.floor(parseInt(/*numbers*/ ctx[8][1]) / 2)} 
                ${parseInt(/*numbers*/ ctx[8][1]) % 2 === 1 ? "1/2" : ""} S.S.`
    	: "") + "";
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*numbers*/ 256 && t_value !== (t_value = (/*numbers*/ ctx[8][1] >= 2
    			? `${Math.floor(parseInt(/*numbers*/ ctx[8][1]) / 2)} 
                ${parseInt(/*numbers*/ ctx[8][1]) % 2 === 1 ? "1/2" : ""} S.S.`
    			: "") + "")) set_data_dev(t, t_value);
    		},
    ...
    // (132:4) {#each scoresDisp as score, i}
    function create_each_block$2(ctx) {
    	let td;
    	let t_value = /*score*/ ctx[18] + "";
    	let t;
    	let mounted;
    	let dispose;

    	function td_input_handler() {
    		/*td_input_handler*/ ctx[15].call(td, /*i*/ ctx[20]);
    	}
    	...
    	const block = {
    		c: function create() {
    			td = element("td");
    			t = text(t_value);
    			attr_dev(td, "class", "tg-0lax fix svelte-udxuym");
    			attr_dev(td, "contenteditable", "");
    			attr_dev(td, "rowspan", "3");
    			if (/*scoresDisp*/ ctx[4][/*i*/ ctx[20]] === void 0) add_render_callback(td_input_handler);
    			add_location(td, file$5, 132, 6, 4159);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, t);

    			if (/*scoresDisp*/ ctx[4][/*i*/ ctx[20]] !== void 0) {
    				td.innerHTML = /*scoresDisp*/ ctx[4][/*i*/ ctx[20]];
    			}
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*scoresDisp*/ 16 && t_value !== (t_value = /*score*/ ctx[18] + "")) set_data_dev(t, t_value);

    			if (dirty & /*scoresDisp*/ 16 && /*scoresDisp*/ ctx[4][/*i*/ ctx[20]] !== td.innerHTML) {
    				td.innerHTML = /*scoresDisp*/ ctx[4][/*i*/ ctx[20]];
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(132:4) {#each scoresDisp as score, i}",
    		ctx
    	});
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(td0, "class", "tg-0lax score svelte-udxuym");
    			attr_dev(td0, "rowspan", "3");
    			add_location(td0, file$5, 163, 6, 5109);
    			attr_dev(td1, "id", "score2");
    			attr_dev(td1, "class", "tg-0lax score svelte-udxuym");
    			attr_dev(td1, "rowspan", "3");
    			add_location(td1, file$5, 164, 6, 5169);
    			attr_dev(td2, "id", "score3");
    			attr_dev(td2, "class", "tg-0lax score svelte-udxuym");
    			attr_dev(td2, "rowspan", "3");
    			add_location(td2, file$5, 165, 6, 5229);
    			attr_dev(td3, "id", "score4");
    			attr_dev(td3, "class", "tg-0lax score svelte-udxuym");
    			attr_dev(td3, "rowspan", "3");
    			add_location(td3, file$5, 166, 6, 5289);
    			attr_dev(td4, "id", "score5");
    			attr_dev(td4, "class", "tg-0lax score svelte-udxuym");
    			attr_dev(td4, "rowspan", "3");
    			add_location(td4, file$5, 167, 6, 5349);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(td0, "class", "svelte-udxuym");
    			add_location(td0, file$5, 151, 12, 4680);
    			attr_dev(tr0, "class", "svelte-udxuym");
    			add_location(tr0, file$5, 150, 10, 4662);
    			attr_dev(td1, "id", "score1");
    			attr_dev(td1, "class", "tg-0lax invis svelte-udxuym");
    			add_location(td1, file$5, 154, 12, 4764);
    			attr_dev(td2, "id", "score2");
    			attr_dev(td2, "class", "tg-0lax invis svelte-udxuym");
    			add_location(td2, file$5, 155, 12, 4822);
    			attr_dev(td3, "id", "score3");
    			attr_dev(td3, "class", "tg-0lax invis svelte-udxuym");
    			add_location(td3, file$5, 156, 12, 4880);
    			attr_dev(td4, "id", "score4");
    			attr_dev(td4, "class", "tg-0lax invis svelte-udxuym");
    			add_location(td4, file$5, 157, 12, 4938);
    			attr_dev(td5, "id", "score5");
    			attr_dev(td5, "class", "tg-0lax invis svelte-udxuym");
    			add_location(td5, file$5, 158, 12, 4996);
    			attr_dev(tr1, "class", "svelte-udxuym");
    			add_location(tr1, file$5, 153, 10, 4746);
    			attr_dev(table, "class", "scoresTable table svelte-udxuym");
    			add_location(table, file$5, 149, 8, 4617);
    			attr_dev(td6, "colspan", "5");
    			attr_dev(td6, "class", "table-housing svelte-udxuym");
    			add_location(td6, file$5, 148, 6, 4569);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	let t1;
    	let td1;
    	let t2_value = (/*twister*/ ctx[7] ? "5" : "") + /*numbers*/ ctx[8] + "";
    	let t2;
    	let t3;
    	let td2;
    	let t4;
    	...
    	let t21_value = (/*twister*/ ctx[7]
    	? `${Math.floor(parseInt(/*numbers*/ ctx[8][2]) / 2) !== 0
		? Math.floor(parseInt(/*numbers*/ ctx[8][2]) / 2)
		: ""} 
              ${parseInt(/*numbers*/ ctx[8][2]) % 2 === 1 ? "1/2" : ""} TWIST`
    	: "") + "";
    	...
    	let t37;
    	let td21;
    	let t38_value = (/*netTotal*/ ctx[5] == "NaN" ? "" : /*netTotal*/ ctx[5]) + "";
    	let t38;
    	let t39;
    	let mounted;
    	let dispose;
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*twister*/ ctx[7]) return create_if_block_1$1;
    		return create_else_block_1;
    	}

    	let current_block_type = select_block_type(ctx);
    	let if_block0 = current_block_type(ctx);
    	let each_value = /*scoresDisp*/ ctx[4];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(td0, "rowspan", "3");
    			attr_dev(td0, "class", "svelte-udxuym");
    			add_location(td0, file$5, 60, 4, 1553);
    			attr_dev(td1, "contenteditable", "");
    			attr_dev(td1, "id", "diveNumbers");
    			attr_dev(td1, "class", "tg-0lax answer svelte-udxuym");
    			attr_dev(td1, "rowspan", "3");
    			if (/*numbersDisp*/ ctx[2] === void 0) add_render_callback(() => /*td1_input_handler*/ ctx[12].call(td1));
    			add_location(td1, file$5, 61, 4, 1633);
    			attr_dev(td2, "contenteditable", "");
    			attr_dev(td2, "id", "pos");
    			attr_dev(td2, "class", "tg-0lax answer svelte-udxuym");
    			attr_dev(td2, "rowspan", "3");
    			if (/*pos*/ ctx[3] === void 0) add_render_callback(() => /*td2_input_handler*/ ctx[13].call(td2));
    			add_location(td2, file$5, 70, 4, 1832);
    			attr_dev(td3, "class", "center-txt svelte-udxuym");
    			add_location(td3, file$5, 80, 10, 2089);
    			attr_dev(td4, "class", "center-txt svelte-udxuym");
    			add_location(td4, file$5, 81, 10, 2130);
    			attr_dev(td5, "class", "center-txt svelte-udxuym");
    			toggle_class(td5, "circle", /*numbers*/ ctx[8][0] === "1");
    			add_location(td5, file$5, 82, 10, 2171);
    			attr_dev(td6, "class", "center-txt svelte-udxuym");
    			toggle_class(td6, "circle", /*numbers*/ ctx[8][0] === "2");
    			add_location(td6, file$5, 83, 10, 2248);
    			attr_dev(td7, "class", "center-txt svelte-udxuym");
    			toggle_class(td7, "circle", /*numbers*/ ctx[8][0] === "3");
    			add_location(td7, file$5, 84, 10, 2325);
    			attr_dev(td8, "class", "center-txt svelte-udxuym");
    			toggle_class(td8, "circle", /*numbers*/ ctx[8][0] === "4");
    			add_location(td8, file$5, 85, 10, 2402);
    			attr_dev(tr0, "class", "svelte-udxuym");
    			add_location(tr0, file$5, 79, 8, 2073);
    			attr_dev(td9, "class", "center-txt svelte-udxuym");
    			attr_dev(td9, "colspan", "2");
    			toggle_class(td9, "circle", !/*twister*/ ctx[7] && /*numbers*/ ctx[8][2] === "1" || /*numbers*/ ctx[8][1] === "1");
    			add_location(td9, file$5, 88, 10, 2508);
    			attr_dev(td10, "class", "center-txt answer svelte-udxuym");
    			attr_dev(td10, "colspan", "2");
    			add_location(td10, file$5, 94, 10, 2700);
    			attr_dev(td11, "class", "center-txt answer svelte-udxuym");
    			attr_dev(td11, "colspan", "2");
    			add_location(td11, file$5, 107, 10, 3210);
    			attr_dev(tr1, "class", "svelte-udxuym");
    			add_location(tr1, file$5, 87, 8, 2492);
    			attr_dev(td12, "class", "col20 center-txt svelte-udxuym");
    			attr_dev(td12, "colspan", "2");
    			add_location(td12, file$5, 119, 10, 3611);
    			attr_dev(td13, "class", "col20 center-txt svelte-udxuym");
    			toggle_class(td13, "circle", /*pos*/ ctx[3] === "C");
    			add_location(td13, file$5, 120, 10, 3672);
    			attr_dev(td14, "class", "col20 center-txt svelte-udxuym");
    			toggle_class(td14, "circle", /*pos*/ ctx[3] === "B");
    			add_location(td14, file$5, 121, 10, 3748);
    			attr_dev(td15, "class", "col20 center-txt svelte-udxuym");
    			toggle_class(td15, "circle", /*pos*/ ctx[3] === "A");
    			add_location(td15, file$5, 122, 10, 3825);
    			attr_dev(td16, "class", "col20 center-txt svelte-udxuym");
    			toggle_class(td16, "circle", /*pos*/ ctx[3] === "D");
    			add_location(td16, file$5, 123, 10, 3901);
    			attr_dev(tr2, "class", "svelte-udxuym");
    			add_location(tr2, file$5, 118, 8, 3595);
    			attr_dev(table, "class", "innerTable table svelte-udxuym");
    			add_location(table, file$5, 78, 6, 2031);
    			attr_dev(td17, "id", "description");
    			attr_dev(td17, "rowspan", "3");
    			attr_dev(td17, "class", "tg-0lax svelte-udxuym");
    			add_location(td17, file$5, 77, 4, 1974);
    			attr_dev(td18, "contenteditable", "");
    			attr_dev(td18, "id", "dd");
    			attr_dev(td18, "class", "tg-0lax svelte-udxuym");
    			attr_dev(td18, "rowspan", "3");
    			if (/*dd*/ ctx[6] === void 0) add_render_callback(() => /*td18_input_handler*/ ctx[14].call(td18));
    			add_location(td18, file$5, 127, 4, 4014);
    			attr_dev(td19, "id", "award6");
    			attr_dev(td19, "class", "tg-0lax svelte-udxuym");
    			attr_dev(td19, "rowspan", "3");
    			add_location(td19, file$5, 141, 4, 4335);
    			attr_dev(td20, "id", "award7");
    			attr_dev(td20, "class", "tg-0lax svelte-udxuym");
    			attr_dev(td20, "rowspan", "3");
    			add_location(td20, file$5, 142, 4, 4387);
    			attr_dev(td21, "id", "netTotal");
    			attr_dev(td21, "class", "tg-0lax svelte-udxuym");
    			attr_dev(td21, "rowspan", "3");
    			add_location(td21, file$5, 143, 4, 4439);
    			attr_dev(tr3, "class", "svelte-udxuym");
    			add_location(tr3, file$5, 59, 2, 1543);
    			attr_dev(tbody, "class", "table-row");
    			add_location(tbody, file$5, 58, 0, 1514);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(td0, "click", /*reset*/ ctx[9], false, false, false),
    					listen_dev(td1, "input", /*td1_input_handler*/ ctx[12]),
    					listen_dev(td2, "input", /*td2_input_handler*/ ctx[13]),
    					listen_dev(td18, "input", /*td18_input_handler*/ ctx[14])
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*twister, numbers*/ 384 && t2_value !== (t2_value = (/*twister*/ ctx[7] ? "5" : "") + /*numbers*/ ctx[8] + "")) set_data_dev(t2, t2_value);
    			...
    			if (dirty & /*twister, numbers*/ 384 && t21_value !== (t21_value = (/*twister*/ ctx[7]
    			? `${Math.floor(parseInt(/*numbers*/ ctx[8][2]) / 2) !== 0
				? Math.floor(parseInt(/*numbers*/ ctx[8][2]) / 2)
				: ""} 
              ${parseInt(/*numbers*/ ctx[8][2]) % 2 === 1 ? "1/2" : ""} TWIST`
    			...
    			if (dirty & /*scoresDisp*/ 16) {
    				each_value = /*scoresDisp*/ ctx[4];
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (dirty & /*netTotal*/ 32 && t38_value !== (t38_value = (/*netTotal*/ ctx[5] == "NaN" ? "" : /*netTotal*/ ctx[5]) + "")) set_data_dev(t38, t38_value);
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	function td1_input_handler() {
    		...
    		($$invalidate(2, numbersDisp), $$invalidate(10, numberPos));
    	}

    	function td2_input_handler() {
    		pos = this.innerHTML;
    		($$invalidate(3, pos), $$invalidate(10, numberPos));
    	}

    	function td18_input_handler() {
    		dd = this.innerHTML;
    		((($$invalidate(6, dd), $$invalidate(2, numbersDisp)), $$invalidate(3, pos)), $$invalidate(10, numberPos));
    	}

    	function td_input_handler(i) {
    		scoresDisp[i] = this.innerHTML;
    		$$invalidate(4, scoresDisp);
    	}

    	$$self.$$set = $$props => {
    		if ("row" in $$props) $$invalidate(0, row = $$props.row);
    		if ("numberPos" in $$props) $$invalidate(10, numberPos = $$props.numberPos);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("scoresDisp" in $$props) $$invalidate(4, scoresDisp = $$props.scoresDisp);
    		if ("finalScore" in $$props) finalScore = $$props.finalScore;
    		if ("scores" in $$props) $$invalidate(11, scores = $$props.scores);
    		if ("netTotal" in $$props) $$invalidate(5, netTotal = $$props.netTotal);
    		if ("dd" in $$props) $$invalidate(6, dd = $$props.dd);
    		if ("twister" in $$props) $$invalidate(7, twister = $$props.twister);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*scoresDisp*/ 16) {
    			$$invalidate(11, scores = scoresDisp.map(x => parseFloat(x) || ""));
    		}

    		if ($$self.$$.dirty & /*scores*/ 2048) {
    			$$invalidate(5, netTotal = (scores.reduce((total, val) => parseFloat(val) + total, 0) - Math.max(...scores) - Math.min(...scores)).toFixed(2));
    		}

    		if ($$self.$$.dirty & /*numberPos*/ 1024) {
    			$$invalidate(2, numbersDisp = numberPos.substring(0, numberPos.length - 1));
    		}
    		...
    		if ($$self.$$.dirty & /*numbersDisp*/ 4) {
    			$$invalidate(7, twister = numbersDisp[0] === "5");
    		}

    		if ($$self.$$.dirty & /*twister, numbersDisp*/ 132) {
    			$$invalidate(8, numbers = twister ? numbersDisp.substring(1) : numbersDisp);
    		}
    	};
    ...
    class DiveTableRow extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { row: 0, numberPos: 10, firstRow: 1 });
    		...
    		if (/*numberPos*/ ctx[10] === undefined && !("numberPos" in props)) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div6, "class", "answer center-txt svelte-pkuf8v");
